...
class UserDataPreferencesOld private constructor(private val userDataStore: DataStore<Preferences>) {
    ...
    companion object {
        @Volatile
        private var INSTANCE: UserDataPreferencesOld? = null
        ...
        fun getInstance(dataStore: DataStore<Preferences>): UserDataPreferencesOld {
            return INSTANCE ?: synchronized(this) {
                val instance = UserDataPreferencesOld(dataStore)
                INSTANCE = instance
                instance
            }
